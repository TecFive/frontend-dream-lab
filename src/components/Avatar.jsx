...
Command: npx gltfjsx@6.2.3 public/models/65f47f1be47ed7cab59c1152.glb -o src/components/Avatar.jsx -k -r public
*/
...
export function Avatar(props) {
  ...
  useEffect(() => {
    ...
    audio.play();
    console.log("Avatar is now talking");
    setAudio(audio);
    audio.onended = () => {
      onMessagePlayed();
...
useGLTF.preload("/models/65f47f1be47ed7cab59c1152.glb");
